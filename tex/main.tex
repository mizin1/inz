...
\pdfinfo
{
    ...
    /Title (System wsparcia procesu obsługi umów cywilno-prawnych - aplikacja w architekturze trójwarstwowej)
    /Subject (Tematyka)
...
\definecolor{ListingBackground}{rgb}{0.96,0.96,0.96}
\linespread{1.5}
...
\input {tex/1_Wprowadzenie}
\input {tex/2_Umowy_cywilno_prawne}
%zamieniam kolejnosc rozdziałów
\input {tex/4_Technologie_wykorzystane_w_aplikacji}
\input {tex/3_Model_funkcjonalny}
\input {tex/5_Model_danych}
\input {tex/6_Implementacja}
\input {tex/7_Podsumowanie}

\appendix

\input {tex/Makiety}
\input {tex/Wyglad_aplikacji}
